...
export default function HomeScreen() {
  ...
  const { darkMode, toggleDarkMode, theme } = useTheme(); // ⬅️ vient du contexte global
  ...
  const categories = [
    ...
    { icon: '💅', label: 'Instituts de beauté', color: ['#fd79a8', '#e84393'] },
    { icon: '🏛️', label: 'Institutions', color: ['#636e72', '#2d3436'] },
  ];
    ...
    <View style={{ flex: 1, backgroundColor: theme.bg }}>
      <LinearGradient colors={['#48cae4', '#0096c7']} style={styles.header}>
        <View style={styles.themeToggle}>
          ...
          <Switch
            value={darkMode}
            onValueChange={toggleDarkMode} // ⬅️ change le thème pour toute l'appli
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 30, fontFamily: 'Poppins_700Bold', color: '#fff', letterSpacing: 1 },
  headerSubtitle: { fontSize: 13, fontFamily: 'Poppins_400Regular_Italic', color: 'rgba(255,255,255,0.9)', marginTop: 6, textAlign: 'center' },
  sectionTitle: { fontSize: 18, fontFamily: 'Poppins_600SemiBold', marginBottom: 16, marginTop: 8 },
  grid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', marginBottom: 24 },
  cardWrapper: { width: '30%', marginBottom: 12 },
  card: { borderRadius: 16, padding: 16, alignItems: 'center', elevation: 5 },
  cardIcon: { fontSize: 32, marginBottom: 8 },
  cardText: { fontSize: 11, fontFamily: 'Poppins_600SemiBold', color: '#fff', textAlign: 'center' },
  actionButton: { borderRadius: 16, padding: 20, flexDirection: 'row', alignItems: 'center', marginBottom: 12, elevation: 5 },
  actionIcon: { fontSize: 32, marginRight: 16 },
  actionTitle: { fontSize: 16, fontFamily: 'Poppins_700Bold', color: '#fff' },
  actionSubtitle: { fontSize: 11, fontFamily: 'Poppins_400Regular_Italic', color: 'rgba(255,255,255,0.85)', marginTop: 4 },
});